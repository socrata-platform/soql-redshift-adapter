...
class SoQLFunctionSqlizerTestRedshift  {
  ...
  @Test
  @DisplayName("equal == works with int")
  def `"equal == works with int"` = {
    assertEquals(analyzeStatement("SELECT text, num WHERE num == 1"), ("""SELECT x1.text AS i1, x1.num AS i2 FROM table1 AS x1 WHERE (x1.num) = (1 :: decimal(30, 7))"""))
  }

  @Test
  @DisplayName("caseless equal works")
  def `"caseless equal works"` = {
  ...
  def `"greater than or equals works"` = {
    assertEquals(analyzeStatement("SELECT text, num WHERE num >= 2"), ("""SELECT x1.text AS i1, x1.num AS i2 FROM table1 AS x1 WHERE (x1.num) >= (2 :: decimal(30, 7))"""))
  }
  ...
  def `"like works with underscore"` = {
  ...
  def `"not like works with percent"` = {
  ...
  def `"not like works with underscore"` = {
  ...
  def `"trimming on both ends works"` = {
  ...
  def `"trimming on leading spaces works"` = {
  ...
  def `"trimming on trailing spaces works"` = {
  ...
  def `"substring(characters, start_index base 1) works"` = {
  ...
  def `"substring(characters, start_index base 1, length) works"` = {
  ...
  def `"uniary plus works"` = {
    assertEquals(analyzeStatement("SELECT text, + num"), ("""SELECT x1.text AS i1, x1.num AS i2 FROM table1 AS x1"""))
  }

  @Test
  @DisplayName("binary minus works")
  def `"binary minus works"` = {
  ...
  def `"binary plus works"` = {
    assertEquals(analyzeStatement("SELECT text, num + 1"), ("""SELECT x1.text AS i1, (x1.num) + (1 :: decimal(30, 7)) AS i2 FROM table1 AS x1"""))
  }

  @Test
  @DisplayName("num times num works")
  def `"num times num works"` = {
  ...
  def `"caseless starts_with works"` = {
  ...
  def `"FixedTimeStampTruncYmdAtTimeZone"` = {
  ...
  def `"FixedTimeStampTruncYmAtTimeZone"` = {
  ...
  def `"FixedTimeStampTruncYAtTimeZone"` = {
  ...
  def `"FloatingTimeStampExtractHh"` = {
  ...
  def `"FloatingTimeStampExtractMm"` = {
  ...
  def `"FloatingTimeStampExtractSs"` = {
  ...
  def `"FloatingTimeStampExtractDow"` = {
  ...
  def `"FloatingTimeStampExtractWoy"` = {
  ...
  def `"FloatingTimestampExtractIsoY"` = {
...
//  tests for geo functions
  ...
  def `"spacial union works for polygons and points"` = {
  ...
  def `"distance_in_meters works for points only"` = {
...
//  tests for window functions
  ...
  def `"(window function) count(*) works"` = {
  ...
  def `"(window function) median works"` = {
  ...
  def `"(window function) stddev_pop works"` = {
  ...
  def `"(window function) stddev_samp works"` = {
